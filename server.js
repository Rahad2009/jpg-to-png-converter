    ...
      const quality = parseInt(req.query.quality, 10) || 75; // Default quality to 75
      ...
      // --- Add this console.log to see the received quality ---
      console.log(`Received quality parameter: ${quality}`);
      // ------------------------------------------------------
    ...
            converted = converted.toFormat(format, { quality }); // <-- This line uses the quality
          } else {
